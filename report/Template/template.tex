...
\title{Sample file for your final report}

\abstract{This is where the abstract should be placed. It should  consist of
one paragraph and give a concise summary of the material in  the article
below.}
...
Eqs.\,(\ref{ex:eq:murnf}\,-\,\ref{ex:eq:potential}).
...
\begin{figure}[b]  % placement directive: b = bottom of column
  \center
  \includegraphics[width=6.5cm]{pic}
...
\begin{figure}[htb] % directives: here, top, bottom
  ...
  \begin{picture}(40,11) % (width,height) in \unitlength
    \put(0,0){\includegraphics[width=0.65\textwidth]{SummerBanner}}
    \put(4,7){\sf\Large HGS-HIRe Summer Student}
    \put(4,3){\sf\Large Program at GSI}
  \end{picture}
  \caption{Summer banner in picture environment}
  \label{ex:fig:banner}
\end{figure}
If you want to place an oversized object, as shown above in
Fig.\,\ref{ex:fig:banner} for our logo reaching out of the standard
